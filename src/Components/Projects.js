      ...
      <div className="flex flex-wrap justify-center items-center">
        {projectData.map((project, index) => (
          <div key={index} className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 p-4">
            <div className="border border-gray-300 p-4 rounded-lg shadow-md bg-white hover:scale-105 transition duration-300">
              ...
              <a
                href={project.link}
                className="text-purple-500 block mt-2 hover:underline"
                target="_blank"
